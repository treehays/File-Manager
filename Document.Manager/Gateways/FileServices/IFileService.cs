...
public interface IFileService
{
    ...
    Task<FilesDatabaseResponseModel> ListOfFilesToDatabase(IList<IFormFile> formFiles, int transactionNumber);
    Task<FilesResponseModel> ListOfFilesToSystem(IList<IFormFile> formFiles, int transactionNumber);
}
